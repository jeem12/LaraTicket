...
<div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-xs text-zinc-400 mt-0.5">Archive of resolved and closed support requests.</p>
        </div>
    </div>
            ...
            <flux:table.rows class="divide-y divide-zinc-800/60">
                @forelse($tickets as $ticket)
                    <flux:table.row class="hover:bg-zinc-800/40 transition-colors">
                        ...
                        <flux:table.cell>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border bg-zinc-800/80 text-zinc-400 border-zinc-700">
